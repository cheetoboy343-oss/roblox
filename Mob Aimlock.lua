...
local function GetClosestMob()
	if not Environment.Locked then
		...
		local MobsFolder = workspace:FindFirstChild("Objects") and workspace.Objects:FindFirstChild("Mobs")
		if MobsFolder then
			for _, v in next, MobsFolder:GetChildren() do
				if v:IsA("Model") and v:FindFirstChild(Environment.Settings.LockPart) and v:FindFirstChildOfClass("Humanoid") then
		...
		if not v or not v.Parent or not v:FindFirstChild(Environment.Settings.LockPart) or not v:FindFirstChildOfClass("Humanoid") then
			CancelLock()
		elseif Environment.Settings.AliveCheck and v:FindFirstChildOfClass("Humanoid").Health <= 0 then
			CancelLock()
		end
	end
end
...
function Environment.Functions:Exit()
	...
	Load = nil; GetClosestMob = nil; CancelLock = nil
end
